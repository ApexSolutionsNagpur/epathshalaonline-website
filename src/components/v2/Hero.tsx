...
const Hero = () => {
  return (
    ...
    >
      <div className=" px-4 md:px-14 py-8 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 relative z-10">
            <h1 className="font-heading text-4xl md:text-4xl font-extrabold text-[#0B3C5D] leading-[1.1] tracking-tight">
              HAR SAPNA HAI <br />
              <span className="text-transparent md:text-6xl   bg-clip-text bg-gradient-to-r from-[#1E5AA8] to-[#00A8A8]">
                POSSIBLE
              </span>
            </h1>
          ...
          <div className="relative h-full hidden lg:flex items-end justify-end z-50 ">
            <div className="absolute -bottom-28 right-0 group">
              {/* Outer Gradient Card */}
              <div className="bg-gradient-to-br from-[#00A8A8] to-[#1E5AA8] p-2 pr-16 rounded-[1.5rem] shadow-2xl transform hover:scale-105 transition-all duration-500">
