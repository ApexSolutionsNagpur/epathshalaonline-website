      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-2">
          {programs.map((program, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl px-2 py-4 shadow-lg hover:shadow-2xl border border-gray-100 hover:border-blue-100 transition-all duration-300 hover:-translate-y-2 group text-center flex flex-col justify-between"
            >
              <div>
