...
const SuccessSection = () => {
  return (
    <section className="py-8 md:py-14 px-4 md:px-28 bg-white overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mx-auto pb-5">

        {/* Left Column - Large Vertical Image */}
        <div className="lg:col-span-7 relative">
          <div className="space-y-4  absolute z-50 top-5 left-5">
            ...
            <div className="w-24 h-1 bg-[#FFC107]  mt-6 rounded-full"></div>
          </div>
